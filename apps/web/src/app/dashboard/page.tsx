...
// Attach x-user-id to all outgoing axios requests so captcha API endpoints
// can identify the current user without requiring per-call configuration.
...
function InquirySenderPanel({
    ...
    try {
      ...
      if (autoSubmit) {
        ...
        if (!submitResponse.ok || !submitData.success) {
          await refreshInquiryResults(activeRunId);
          if (submitData.code === 'RUN_STOPPED' || runStateRef.current === 'stopped') return false;
  ...
  return (
    <div className="space-y-4">
      ...
      <Panel title="CAPTCHA Solving">
        <div className="space-y-6">
          <h2 className="text-lg font-semibold text-gray-900">CAPTCHA Solving</h2>
          <CaptchaSettings />
